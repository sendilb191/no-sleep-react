  ...
  return (
    <div className='instructions'>
      ...
      <div className='instruction-section'>
        ...
        <ul>
          ...
          <li>
            ...
            current charge level with color-coded states (green for good, yellow
            for low, red for critical)
          </li>
          <li>
            <strong>Charging Detection:</strong> Automatically detects when your
            device is plugged in and displays charging animation
          </li>
          <li>
            <strong>Smart Warnings:</strong> Shows power drain alerts when wake
            lock is active and battery is low (≤30%) while not charging
          </li>
          <li>
            <strong>API Support:</strong> Displays whether your browser supports
            the Battery API for accurate monitoring
          </li>
        </ul>
      </div>
      ...
      <div className='instruction-section'>
        ...
        <ul>
          <li>
            <strong>Wake Lock API:</strong> Uses the modern Screen Wake Lock API
            when available for the most reliable screen-on functionality
          </li>
          <li>
          ...
          <li>
            <strong>Browser Compatibility:</strong> Shows API support status and
            active fallback method for full transparency
          </li>
        </ul>
      </div>
      ...
      <div className='instruction-section'>
        ...
        <ul>
          ...
          <li>
            <strong>Test Functionality:</strong> Built-in test button to verify
      ...
      <div className='instruction-section'>
        ...
        <ul>
          ...
          <li>
            <strong>Smart Cooldown:</strong> 10-minute intervals between battery
            warnings to prevent notification spam
          </li>
          <li>
          ...
          <li>
            <strong>Permission Management:</strong> Clear status indicators and
            easy permission requests for notification access
          </li>
          <li>
            <strong>Cross-Platform:</strong> Works on desktop and mobile devices
            that support web notifications
          </li>
        </ul>
      </div>
      ...
      <div className='instruction-section'>
        ...
        <ul>
          <li>
            <strong>Active Tab:</strong> Keep the browser tab active and visible
            for optimal wake lock performance
          </li>
          <li>
            <strong>Power Management:</strong> Monitor battery levels regularly,
            especially when using sleep prevention on battery power
          </li>
          <li>
