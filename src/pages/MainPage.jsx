        ...
        <div className='section-body'>
          <div className='status-grid'>
            <div className='status-item'>
              <span className='status-label'>Wake Lock Support</span>
        ...
        <div className='section-body'>
          <div className='action-buttons'>
            <button
              ...
              className={`btn btn-gradient ${isWakeLockEnabled ? 'btn-active' : 'btn-inactive'}`}
            >
              {isWakeLockEnabled ? '🔓 Release' : '🔒 Enable'}
            </button>
